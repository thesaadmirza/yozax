<?php
$yx['title']       = $lang['search'] . ' | ' . $yx['config']['title'];
...
$search_results = YX_Search(array('keyword' => $keyword, 'limit' => 20));
...
foreach ($search_results as $key => $search_results_) {
	foreach ($search_results_ as $key_ => $results) {
		if ($key == 'news') {
			$news_html .= YX_Loadpage('search/lists/news', array(
				'NEWS_ID' => $results['id'],
		        'NEWS_URL' => $results['url'],
		        'NEWS_ENCODED_URL' => urlencode($results['url']),
		        'NEWS_IMAGE' => YX_GetMedia($results['image']),
		...
		if ($key == 'lists') {
			$lists_html .= YX_Loadpage('search/lists/news', array(
				'NEWS_ID' => $results['id'],
		        'NEWS_URL' => $results['url'],
		        'NEWS_ENCODED_URL' => urlencode($results['url']),
		        'NEWS_IMAGE' => YX_GetMedia($results['image']),
		...
		if ($key == 'videos') {
			$videos_html .= YX_Loadpage('search/lists/news', array(
				'NEWS_ID' => $results['id'],
		        'NEWS_URL' => $results['url'],
		        'NEWS_ENCODED_URL' => urlencode($results['url']),
		        'NEWS_IMAGE' => YX_GetMedia($results['image']),
		...
		if ($key == 'music') {
			$music_html .= YX_Loadpage('search/lists/news', array(
				'NEWS_ID' => $results['id'],
		        'NEWS_URL' => $results['url'],
		        'NEWS_ENCODED_URL' => urlencode($results['url']),
		        'NEWS_IMAGE' => YX_GetMedia($results['image']),
		...
		if ($key == 'polls') {
			$polls_html .= YX_Loadpage('search/lists/news', array(
				'NEWS_ID' => $results['id'],
		        'NEWS_URL' => $results['url'],
		        'NEWS_ENCODED_URL' => urlencode($results['url']),
		        'NEWS_IMAGE' => YX_GetMedia($results['image']),
		...
		if ($key == 'quiz') {
			$quiz_html .= YX_Loadpage('search/lists/news', array(
				'NEWS_ID' => $results['id'],
		        'NEWS_URL' => $results['url'],
		        'NEWS_ENCODED_URL' => urlencode($results['url']),
		        'NEWS_IMAGE' => YX_GetMedia($results['image']),
...
$yx['content'] = YX_LoadPage('search/content', array(
    'SEARCH_KEYWORD' => YX_Secure($keyword),
