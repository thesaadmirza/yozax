<?php 
$yx['title']       = $lang['latest_news'] . ' | ' .$yx['config']['title'];
...
if (!empty($_GET['c_id'])) {
	if (in_array($_GET['c_id'], array_keys($yx['news_categories']))) {
...
$latest_page_news = $yx['latest_page_news'] = YX_FetchDataFromDB($fetch_latest_news_page_data_array);

$yx['content'] = YX_LoadPage('latest/news', array('TOP_4' => $top_news_html, 'TOP_BIG' => $big_top_news_html));
?>