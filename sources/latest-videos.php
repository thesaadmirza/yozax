...
if (!empty($_GET['c_id'])) {
	if (in_array($_GET['c_id'], array_keys($yx['video_categories']))) {
...
$latest_page_videos = $yx['latest_page_videos'] = YX_FetchDataFromDB($fetch_latest_news_page_data_array);

$yx['content'] = YX_LoadPage('latest/videos', array('TOP_4' => $top_news_html, 'TOP_BIG' => $big_top_news_html));
?>