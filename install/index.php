...
?>';
        ...
        if ($config_file) {
            ...
            if ($query) {
                /* $p2 = check_success($_POST['access_code']);*/
                if (isset($p2['status'])) {
...
<head>
    <meta charset="UTF-8">
    <title>FLAME Package | Installation</title>
                ...
                <div class="list-group">
                    ...
                    <div class="setting-panel">
                        ...
                        <?php } else if ($page == 'finish') { ?>
                            <div class="req">
                                <h5>FLAME package has been successfully installed, if you have any question, please let us <a href="mailto:flame@firehide.com">know</a></h5>
                                <br>
                        ...
                        <?php } else if ($page == 'installation') { ?>
                            <div class="req">
                                ...
                                <form action="?page=installation" method="post" class="form-horizontal install-site-setting">
                                    <div class="form-group">
                                        <label class="col-md-3" for="siteName">Access code </label>
                                        <div class="col-md-6">
                                            <input type="text" class="form-control" name="access_code" value="<?php echo (!empty($_POST['access_code'])) ? $_POST['access_code'] : ''; ?>">
                                            <span class="help-block">Your Firehide Teams access code, you can get it from <a href="https://help.teams.firehide.com/hc/en-us/articles/xxxxxx">Here</a>.</span>
                                        </div>
                                    </div>
                                    <div class="form-group">
...
<style>
    ...
    .nav-tabs>li.active>a:hover {
        ...
        cursor: default;
        color: #ef4957;
        border-bottom: 1px solid #ef4957;
